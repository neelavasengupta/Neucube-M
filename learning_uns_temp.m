function [unsupervised_spike,unsupervised_weight] = learning_uns_temp( class_labels, spike_train, neucube_connection, initial_neucube_weight,input_mapping, refractory_time, threshold_potential, leak_rate, STDP_rate,learning_rate,training_cycle,fid)
...
% [training_accuracy,test_accuracy]=tempotron_training(input_spike,class_labels,train_fold,learning_rate,training_cycle);
