function [unsupervised_spike,unsupervised_potential,unsupervised_weight,result] = Neucube_best_model( spike_train,class_labels,neucube_connection, initial_neucube_weight, input_mapping, refractory_time, threshold_potential, leak_rate, STDP_rate,lambda)
